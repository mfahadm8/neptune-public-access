...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="process_graph-traversal.js.html">process/graph-traversal.js</a>, <a href="process_graph-traversal.js.html#line1754">line 1754</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="toArrayBuffer"><span class="type-signature"></span>toArrayBuffer<span class="signature">(buffer)</span><span class="type-signature"> &rarr; {ArrayBuffer}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line114">line 114</a>
    </li></ul></dd>
...
<span class="param-type">Number</span>
        ...
        <tr>
                ...
                <td class="name"><code>materializeProperties</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last">Indicates whether element properties should be returned or not.</td>
        </tr>
